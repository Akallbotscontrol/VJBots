...
BOT_TOKEN = environ.get('BOT_TOKEN', "7465797840:AAE6JsXzR78YFO5BHiASSlIIGG_nDpQMm9g")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002340341639').split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Lordbobbybot:Lordbobbybot@lordbobbybot.3iiuu.mongodb.net/?retryWrites=true&w=majority&appName=Lordbobbybot")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "Lordbobbydb")
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://i.ibb.co/LNHxQvs/IMG-20241030-144812.jpg') # payment code picture url.
...
PUBLIC_FILE_CHANNEL = environ.get('PUBLIC_FILE_CHANNEL', 'File_channel_0') # Public Channel Username Without @ or without https://t.me/ and Bot Is Admin With Full Right.


# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/MOVIE_MINES_GROUP')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/movie_mines_main')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'disscuss_groupp') # Support Chat Link Without https:// or @
